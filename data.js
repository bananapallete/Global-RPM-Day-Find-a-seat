...
const SEATS_RAW = {
  ...
  I: ["이종훈","조원준","전제석","강소라","김기봉","허정우","윤승훈","신정윤","이승현","박민호","이진오","임정민","이준희","강재석","김용준","정민교","정승완","오동현","김규보","박하림","박철우"],
...
const SEATS_RAW_EN = {
  ...
  I: ["Lee Jonghun","Cho Wonjun","Jeon Jeseok","Kang Sora","Kim Kibong","Heo Jeongu","Yoon Seunghoon","Shin Jeongyoon","Lee Seunghyun","Park Minho","Lee Jinoh","Lim Jeongmin","Lee Junhee","Kang Jaeseok","Kim Yongjoon","Jeong Minkyo","Jeong Seungwan","Oh Donghyun","Kim Gyubo","Park Harim","Park Chulwoo"],
